...
using Community.PowerToys.Run.Plugin.CursorWorkspaces.Properties;
using Community.PowerToys.Run.Plugin.CursorWorkspaces.RemoteMachinesHelper;
...
namespace Community.PowerToys.Run.Plugin.CursorWorkspaces
{
    public class Main : IPlugin, IContextMenu, IPluginI18n
    {
        ...
        public static string PluginID => "B6C9862D3B8A408983C22237E1ECDA17";
        ...
        private readonly CursorWorkspacesApi _workspacesApi = new CursorWorkspacesApi();

        private readonly CursorRemoteMachinesApi _machinesApi = new CursorRemoteMachinesApi();
        ...
        public List<Result> Query(Query query)
        {
            ...
            results.ForEach(x =>
            {
                ...
                if (x.ContextData is CursorRemoteMachine)
                {
        ...
        private void HandleError(string msg, Exception exception = null, bool showMsg = false)
        {
            ...
            {
                Log.Error(msg, typeof(CursorWorkspaces.Main));
            }
